...
public class LanguageValidatorTests {
	...
	public void validateSuccessfulTest() {
		...
		language.setDisplayLanguage("English");
	...
	public void validateLocaleNullTest() {
		...
		validator.validate(language, errors);
		assertEquals("Locale can not be empty", errors.getAllErrors().get(0).getCode());
	}
	...
	public void validateDisplayLanguageNullTest() {
		...
		validator.validate(language, errors);
		assertEquals("Language display name can not be empty", errors.getAllErrors().get(0).getCode());
	}
}
